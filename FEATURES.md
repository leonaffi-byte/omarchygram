...
MERGED. Wave 5 (Telegram parity: layout/chrome, in-app configuration, daily-use and regular-use functions — specs/spec-wave5.md) is IN PROGRESS: backend contract + real implementation merged 2026-09-02; UI packages 5A (layout/chrome), 5B (in-app configuration) and 5C (daily-use functions) MERGED 2026-09-02; 5D (regular-use functions) in progress.
